...
export const HUSTLES = {
  ...
  solo: {name: "Solo", bands: [1, 2, 2, 1, 0, 1], text: ["did bodyguard work for a low-end client", "did bodyguard work for a high-end client", "pulled off a difficult hit or extraction", "hired out as muscle to a Fixer, Corp, or Gang", "attracted undue attention and had to lay low", "did basic enforcer or hitman work for a local Corp"]},
  ...
  tech: {name: "Tech", bands: [0, 1, 2, 1, 1, 1], text: ["found no jobs this week", "rebuilt some tech they scavenged in the Combat Zone", "helped a client break into some place or installed security systems for a client", "did some modifications or repairs to some cybertech", "did some modifications or repairs to some weapons", "sabotaged or otherwise disabled something for a client"]},
